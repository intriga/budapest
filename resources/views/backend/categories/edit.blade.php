                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <form method="post" action="{{ url('/admin/category/'.$category->slug.'/edit') }}">
                            {{ csrf_field() }}
                                
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <div class="form-group">
                                        <input id="title" class="form-control" name="title" value="{{ $category->title }}">
                                        @if (count($errors) > 0)
                                        ...
                                        @endif
                                        <input type="hidden" id="slug" class="form-control" name="slug"  value="{{ $category->slug }}">
                                    </div>
                                </div>
                                <!-- /.card-body -->
